...
\newline \newline
2. $f$ étant un minimum de fonctions concaves, elle est concave, donc quasi-concave. On sait encore grâce au cours de micro que $f$ n'est pas strictement quasi-concave. \newline
