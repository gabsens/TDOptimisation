...
\subsection{} \noindent\fbox{
\parbox{\linewidth}{
Soit $n\geq 1$ et $f:\mathbb R^*_+\to \mathbb R$ définie par $$f(x_1,\ldots, x_n)=\left(\prod_{i=1}^n x_i \right) ^{1/n}$$
...
\newline
2. Il n'y a aucun moyen d'éviter de passer par la définition de "strictement quasi-concave" et je n'ai pas réussi. \newline
\newline
...
\\ 
\\
\noindent 1. La concavité s'étudie avec la Hessienne. L'étude de la quasi-concavité fait (nécessairement ?) appel à la Hessienne bordée (qui n'a pas été vue en cours). L'étude de la stricte-quasi-concavité semble très difficile, vu le cas particulier du 5.18. C'est pourtant quelque chose qui a été utilisé à de nombreuses reprises dans le cours de microéconomie... \newline
\newline
2. $f$ étant un minimum de fonctions concaves, elle est concave. La quasi-concavité est connue (cf courbes d'indifférence de Leontieff en microéconomie) mais semble difficile à prouver (la fonction considérée n'est pas différentiable). On sait encore grâce au cours de micro que $f$ n'est pas strictement quasi-concave.
...
En faisant $z\xrightarrow[<]{superscript}f(x)$, on a $$\langle \frac{u^*}{\alpha} ,x-x_0\rangle \leq f(x_0) -f(x)$$ donc 
